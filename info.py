...
USERNAME = environ.get('USERNAME', "https://telegram.me/bitget_srilankan")
...
SECOND_FILES_DATABASE_URL = environ.get('SECOND_FILES_DATABASE_URL', "mongodb+srv://savindukaushalya29_db_user:euUvJeZcsI42h7ez@db2.aadpenw.mongodb.net/?retryWrites=true&w=majority&appName=db2") # 2nd DB For Files
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002324418733'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002324418733'))
...
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "--1002456874247")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels = environ.get("AUTH_CHANNELS", "-1002456874247")# Channels for force sub (make sure bot is admin)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002324418733'))  # Notification of sent to your channel
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002892281095').split()] # Auto Index Channel
